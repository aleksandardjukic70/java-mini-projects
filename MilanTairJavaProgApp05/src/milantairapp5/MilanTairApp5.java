package milantairapp5;

import java.util.Scanner;

public class MilanTairApp5 { /* NAREDBA PONAVLJANJA - CIKLUS WHILE (PETLJA) */

    public static void main(String[] args) { /* PROGRAM BANKOMATA */ 
         ...
         if (zaIsplatu5 > 0) {
             System.out.println("Isplatiti " + zaIsplatu5 + " novcanica od 5.");
         }
         
         if (zaIsplatu2 > 0) {
             System.out.println("Isplatiti " + zaIsplatu2 + " novcanica od 2.");
         }
         
         if (zaIsplatu1 > 0) {
             System.out.println("Isplatiti " + zaIsplatu1 + " novcanica od 1.");
         }
